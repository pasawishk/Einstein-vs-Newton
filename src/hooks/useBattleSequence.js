...
import { heal,magic,attack,opponentStats, playerStats } from "shared";
      ...
      if (mode) {
        ...
        switch (mode) {
          case 'attack': {
            ...
            (async () => {
              setInSequence(true);
              setAnnouncerMessage(`${attacker.name} start lecturing calculus to ${receiver.name}!`);
              await wait(1500);
          ...
          case 'magic': {
            ...
            (async () => {
              setInSequence(true);
              setAnnouncerMessage(`${attacker.name} has cast a Quantum spell!`);
              await wait(1000);
          ...
          case 'heal': {
            ...
            (async () => {
              setInSequence(true);
              setAnnouncerMessage(`${attacker.name} has chosen to relatively heal!`);
              await wait(1000);
